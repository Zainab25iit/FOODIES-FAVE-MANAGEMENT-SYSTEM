...
public class FoodCenter extends Application {

    private static final int MAX_QUEUES = 3;
    private static FoodQueue[] queues;
    static int stock = FoodQueue.MAX_STOCK;
    ...
    public void start(Stage primaryStage) throws Exception {
        try{
        FoodCenterGUI foodCenterGUI = new FoodCenterGUI(queues);
        foodCenterGUI.runGUI(primaryStage);}
        catch (Exception e)
        {
            e.printStackTrace();
        }
    ...
    private static void displayMenu() {
        ...
        System.out.println("112 or OPG: GUI.");
    ...
    static FoodQueue getQueueWithMinimumLength() {
