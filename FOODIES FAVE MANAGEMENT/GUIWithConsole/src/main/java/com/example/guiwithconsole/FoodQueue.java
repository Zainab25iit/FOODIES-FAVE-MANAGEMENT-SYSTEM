...
public class FoodQueue {
    ...
    private List<Customer> waitingListCustomers;
    ...
    public FoodQueue(String queueName) {
        ...
        waitingListCustomers = new ArrayList<>();
    }
    ...
    public List<Customer> getWaitingListCustomers() {
        CircularQueue<Customer> customerCircularQueue = getWaitingList();
        Customer customers[] = customerCircularQueue.elements;
    ...
    private static class CircularQueue<Customerr> {
        ...
        public boolean offer(Customer element) {
            if (isFull()) {
                return false;
            }
            rear = (rear + 1) % maxSize;
        ...
        public Customer poll() {
            ...
            Customer element = elements[front];
